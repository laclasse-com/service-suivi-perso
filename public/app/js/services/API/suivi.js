angular.module( 'suiviApp' )
    .factory( 'SearchByName', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/carnets/eleves/:name', {
            name: '@name'
        } );
    } ] )
    .factory( 'EvignalSearchByName', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/carnets/evignal/eleves/:name', {
            name: '@name'
        } );
    } ] )
    .factory( 'GetByClasse', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/carnets/classes/:id', {
            id: '@id'
        } );
    } ] )
    .factory( 'Create', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/carnets/', {
            uid_elv: '@uid_elv',
            full_name_elv: '@full_name_elv',
            etablissement_code: '@etablissement_code',
            classe_id: '@classe_id',
            uid_adm: '@uid_adm',
            full_name_adm: '@full_name_adm',
            profil_adm: '@profil_adm',
    ...
    .factory( 'CarnetPdf', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/carnets/:uid_elv/pdf', {
            uid_elv: '@uid_elv'
        }, {
            'post': {
                method: 'POST',
                ...
                params: {
                    ...
                    college: '@college',
                    sexe: '@sexe',
                    id_onglets: '@id_onglets'
                }
            }
        } );
    } ] )
    .factory( 'CarnetPersonnelsEvignal', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/carnets/evignal/personnels', {
            uid_elv: '@uid_elv',
            hopital: '@hopital'
        } );
    } ] )
    ...
    .factory( 'Entrees', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/entrees/', {
            id_onglet: '@id_onglet'
        }, {
            'get': {
                method: 'GET'
            ...
            'update_avatar': {
                method: 'PUT',
                url: APP_PATH + '/api/entrees/:uid/avatar',
                params: {
                    uid: '@uid',
                    avatar: '@avatar'
                }
            ...
            'deleteDoc': {
                method: 'DELETE',
                url: APP_PATH + '/api/entrees/delete/docs/:id',
                params: {
                    id: '@id',
                    id_carnet: '@id_carnet'
                }
            ...
            'getDoc': {
                method: 'GET',
                responseType: 'blob',
                url: APP_PATH + '/api/entrees/docs/:id',
                params: {
                    id: '@id',
                    id_carnet: '@id_carnet'
                }
            ...
            'postDoc': {
                method: 'POST',
                url: APP_PATH + '/api/entrees/upload/documents',
                params: {
                    id_carnet: '@id_carnet',
                    id_entree: '@id_entree',
                    file: '@file'
    ...
    .factory( 'Rights', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/rights/', {
            id: '@id'
        }, {
            'get': {
                method: 'GET'
            ...
            'carnets': {
                method: 'GET',
                isArray: false,
                url: APP_PATH + '/api/rights/carnets/:uid_elv',
                params: {
                    uid_elv: '@uid_elv',
                    evignal: '@evignal'
                }
            ...
            'users': {
                method: 'GET',
                isArray: false,
                url: APP_PATH + '/api/rights/users/:uid',
                params: {
                    uid: '@uid',
                    uid_elv: '@uid_elv',
                    carnet_id: '@carnet_id'
    ...
    .factory( 'Public', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/public/', {
            id: '@url_pub'
        }, {
            'get': {
                method: 'GET'
            ...
            'post': {
                method: 'POST',
                url: APP_PATH + '/api/public/carnets/:uid_elv',
                params: {
                    uid_elv: '@uid_elv',
                    id_onglets: '@id_onglets'
                }
    ...
    .factory( 'Docs', [ '$resource', 'DOCS_URL', function ( $resource, DOCS_URL ) {
        return $resource( DOCS_URL + '/api/suivi/', {
            id_carnet: '@id_carnet',
            md5: '@md5',
            nom: '@nom'
        }, {
    ...
    .factory( 'Stats', [ '$resource', 'APP_PATH', function ( $resource, APP_PATH ) {
        return $resource( APP_PATH + '/api/stats/', {}, {
            ...
            'csv': {
                method: 'GET',
                url: APP_PATH + '/api/stats/csv',
                params: {},
                responseType: 'blob'
            },
            'evignal': {
                method: 'GET',
                url: APP_PATH + '/api/stats/evignal',
                params: {}
            },
        } );
    } ] );
    ...
    .service( 'Carnets', [ 'GRID_COLOR', 'Create', 'CurrentUser', 'CarnetsFact', 'URL_ENT', 'CreateEvignal', 'UAI_EVIGNAL', function ( GRID_COLOR, Create, CurrentUser, CarnetsFact, URL_ENT, CreateEvignal, UAI_EVIGNAL ) {
        ...
        this.get_by_name = function ( reponse ) {
            ...
            while ( i < 16 || i % 4 != 0 ) {
                carnets.push( {
                    id: null,
                    couleur: GRID_COLOR[ i % GRID_COLOR.length ],
                    uid_elv: null,
                    firstName: '',
                    lastName: '',
                    classe: '',
                    classe_id: null,
                    etablissement_code: null,
        ...
        this.create = function ( carnet, with_model ) {
            ...
            return Create.post( {
                ...
                full_name_elv: carnet.firstName + " " + carnet.lastName.toLowerCase(),
                etablissement_code: carnet.etablissement_code,
                classe_id: carnet.classe_id,
                uid_adm: currentUser.id_ent,
                full_name_adm: full_name_adm,
                profil_adm: profil,
                with_model: with_model
            } );
