var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,d,e){a instanceof String&&(a=String(a));for(var f=a.length,g=0;g<f;g++){var b=a[g];if(d.call(e,b,g,a))return{i:g,v:b}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,d,e){a!=Array.prototype&&a!=Object.prototype&&(a[d]=e.value)};
...
$jscomp.polyfill("Array.prototype.findIndex",function(a){return a?a:function(a,e){return $jscomp.findInternal(this,a,e).i}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.Symbol=function(){var a=0;return function(d){return $jscomp.SYMBOL_PREFIX+(d||"")+a++}}();
...
$jscomp.polyfill("Promise",function(a){function d(){this.batch_=null}function e(a){return a instanceof g?a:new g(function(c,b){c(a)})}if(a&&!$jscomp.FORCE_POLYFILL_PROMISE)return a;d.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};d.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var f=$jscomp.global.setTimeout;d.prototype.asyncExecuteFunction=function(a){f(a,
0)};d.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var c=0;c<a.length;++c){var b=a[c];delete a[c];try{b()}catch(m){this.asyncThrow_(m)}}}this.batch_=null};d.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var g=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var c=this.createResolveAndReject_();try{a(c.resolve,c.reject)}catch(k){c.reject(k)}};g.prototype.createResolveAndReject_=
function(){function a(a){return function(k){b||(b=!0,a.call(c,k))}}var c=this,b=!1;return{resolve:a(this.resolveTo_),reject:a(this.reject_)}};g.prototype.resolveTo_=function(a){if(a===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(a instanceof g)this.settleSameAsPromise_(a);else{a:switch(typeof a){case "object":var c=null!=a;break a;case "function":c=!0;break a;default:c=!1}c?this.resolveToNonPromiseObj_(a):this.fulfill_(a)}};g.prototype.resolveToNonPromiseObj_=function(a){var c=
void 0;try{c=a.then}catch(k){this.reject_(k);return}"function"==typeof c?this.settleSameAsThenable_(c,a):this.fulfill_(a)};g.prototype.reject_=function(a){this.settle_(2,a)};g.prototype.fulfill_=function(a){this.settle_(1,a)};g.prototype.settle_=function(a,c){if(0!=this.state_)throw Error("Cannot settle("+a+", "+c|"): Promise already settled in state"+this.state_);this.state_=a;this.result_=c;this.executeOnSettledCallbacks_()};g.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var a=
this.onSettledCallbacks_,c=0;c<a.length;++c)a[c].call(),a[c]=null;this.onSettledCallbacks_=null}};var b=new d;g.prototype.settleSameAsPromise_=function(a){var c=this.createResolveAndReject_();a.callWhenSettled_(c.resolve,c.reject)};g.prototype.settleSameAsThenable_=function(a,c){var b=this.createResolveAndReject_();try{a.call(c,b.resolve,b.reject)}catch(m){b.reject(m)}};g.prototype.then=function(a,c){function b(a,c){return"function"==typeof a?function(c){try{d(a(c))}catch(q){f(q)}}:c}var d,f,e=new g(function(a,
c){d=a;f=c});this.callWhenSettled_(b(a,d),b(c,f));return e};g.prototype.catch=function(a){return this.then(void 0,a)};g.prototype.callWhenSettled_=function(a,c){function k(){switch(d.state_){case 1:a(d.result_);break;case 2:c(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?b.asyncExecute(k):this.onSettledCallbacks_.push(function(){b.asyncExecute(k)})};g.resolve=e;g.reject=function(a){return new g(function(c,b){b(a)})};g.race=function(a){return new g(function(c,
b){for(var d=$jscomp.makeIterator(a),k=d.next();!k.done;k=d.next())e(k.value).callWhenSettled_(c,b)})};g.all=function(a){var c=$jscomp.makeIterator(a),b=c.next();return b.done?e([]):new g(function(a,d){function k(c){return function(b){f[c]=b;m--;0==m&&a(f)}}var f=[],m=0;do f.push(void 0),m++,e(b.value).callWhenSettled_(k(f.length-1),d),b=c.next();while(!b.done)})};return g},"es6","es3");
...
angular.module("suiviApp").component("droits",{bindings:{uidEleve:"\x3c",droits:"\x3d",concernedPeople:"\x3c"},controller:["Droits","APIs","UID","URL_ENT","User",function(a,d,e,f,g){var b=this;b.sharing_enabled=!1;var h=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var c=16*Math.random()|0;return("x"==a?c:c&3|8).toString(16)})};b.add=function(c){c.new=!0;c.dirty={uid:!1,profil_id:!1,group_id:!1,sharable_id:!1,read:!1,write:!1,manage:!1};b.droits.push(new a(c))};
b.add_sharable=function(a){a.sharable_id=h();b.add(a)};var c=function(a){_(a).has("dirty")||(a.dirty={uid:!1,profil_id:!1,group_id:!1,sharable_id:!1,read:!1,write:!1,manage:!1})};b.set_read=function(a){c(a);a.dirty.read=!0;!a.read&&a.write&&(a.write=!1,a.dirty.write=!0);!a.read&&a.manage&&(a.manage=!1,a.dirty.manage=!0)};b.set_write=function(a){c(a);a.dirty.write=!0;a.write&&!a.read&&(a.read=!0,a.dirty.read=!0);!a.write&&a.manage&&(a.manage=!1,a.dirty.manage=!0)};b.set_manage=function(a){c(a);a.dirty.manage=
!0;a.manage&&!a.write&&(a.write=!0,a.dirty.write=!0);a.manage&&!a.read&&(a.read=!0,a.dirty.read=!0)};b.update_deletabilities=function(){b.droits.forEach(function(a){a.deletable=a.uid!=e;void 0!=b.uidEleve&&(a.deletable=a.deletable&&a.uid!=b.uidEleve)})};b.$onInit=function(){b.UID=e;b.update_deletabilities();d.query_profiles_types().then(function(a){b.profils=a.data},function(a){});g.get({id:e}).$promise.then(function(a){return a.get_actual_groups()}).then(function(a){b.groups=a.filter(function(a){return"GPL"==
...
angular.module("suiviApp").config(["$compileProvider",function(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|javascript|blob|data):/)}]).component("onglet",{bindings:{uids:"\x3c",onglets:"\x3c",onglet:"\x3d"},controller:["$uibModal","$state","$q","$window","$sce","$location","Saisies",function(a,d,e,f,g,b,h){var c=this;c.order_by={field:"date",reverse:!0};c.callback_popup_onglet=function(a){"deleted"==a.action&&d.go("carnet",{uids:c.uids},{reload:!0})};c.saisie_callback=function(a){switch(a.action){case "created":c.saisies.push(a);
k();break;case "deleted":c.saisies=c.saisies.filter(function(c){return c.id!=a.id});break;case "updated":var b=c.saisies.findIndex(function(c){return c.id==a.id});c.saisies[b]=a;break;default:console.log("What to do with this?"),console.log(a)}};var k=function(){c.new_saisie=c.onglet.writable?{create_me:!0}:null};a=function(a){return function(){return function(c){return c.pinned==a}}};c.filter_pinned=a(!0);c.filter_unpinned=a(!1);c.$onInit=function(){k();h.query({"onglets_ids[]":c.onglet.ids}).$promise.then(function(a){c.saisies=
...
angular.module("suiviApp").component("onglets",{bindings:{uids:"\x3c"},controller:["$uibModal","Onglets","Popups","APIs","User","UID",function(a,d,e,f,g,b){var h=this;h.popup_onglet=e.onglet;h.callback_popup_onglet=function(a){if(a[0].created){var c=a[0];c.ids=a.map(function(a){return a.id});h.onglets.push(c)}a[0].deleted&&(h.onglets=h.onglets.filter(function(c){return c.nom!=a[0].nom}))};h.$onInit=function(){1==h.uids.length?e.loading_window("Chargement des onglets","",function(){return d.query({"uids[]":h.uids}).$promise.then(function(a){h.onglets=
_(a[0]).map(function(a){a.ids=[a.id];return a})},function(a){})}):e.loading_window("Chargement des onglets communs","",function(){return f.query_common_onglets_of(h.uids).then(function(a){h.onglets=Object.keys(a).map(function(c){return{nom:c,ids:a[c].map(function(a){return a.id}),writable:a[c].reduce(function(a,c){return a&&c.writable},!0),manageable:a[c].reduce(function(a,c){return a&&c.manageable},!0)}})})});g.get({id:b}).$promise.then(function(a){h.current_user=a;h.can_add_tab=h.current_user.can_add_tab(h.uids)})}}],
...
angular.module("suiviApp").factory("User",["$resource","$rootScope","$q","APIs","URL_ENT",function(a,d,e,f,g){return a(g+"/api/users/:id",{id:"@id",expand:"@expand"},{get:{cache:!1,transformResponse:function(a){var b=angular.fromJson(a);b.is_admin=function(){return 0<b.profiles.length&&void 0!=_(b.profiles).findWhere({type:"ADM"})};b.can_do_batch=0<_("ADM DIR DOC ENS ETA EVS ORI TUT".split(" ")).intersection(_(b.profiles).pluck("type")).length;b.can_add_tab=function(a){return b.can_do_batch||1==a.length&&
a[0]==b.id};b.get_actual_groups=function(){return f.get_groups(_(b.groups).pluck("group_id")).then(function(a){b.actual_groups=a.data;return e.resolve(b.actual_groups)})};b.get_actual_subjects=function(){return f.get_subjects(_(b.groups).pluck("subject_id")).then(function(a){b.actual_subjects=a.data;return e.resolve(b.actual_subjects)})};b.query_people_concerned_about=_.memoize(function(){var a=[],d=[],g=[],h=[],n=[],l=[];return f.query_profiles_types().then(function(a){d=_(a.data).indexBy("id");
return _(b.parents).isEmpty()?e.resolve({no_parents:!0}):f.get_users(_(b.parents).pluck("parent_id"))},function(a){return e.reject(a)}).then(function(c){_(c).has("data")&&a.push(_(c.data).map(function(a){a.type="Responsable"+(1<c.data.length?"s":"")+" de l'\u00e9l\u00e8ve";return a}));return 0<b.profiles.length?f.get_structures(_(b.profiles).pluck("structure_id")):e.resolve({no_profile:!0})},function(a){return e.reject(a)}).then(function(a){return _(a).has("data")?(h=_.chain(a.data).pluck("profiles").flatten().reject(function(a){return _(["ELV",
"TUT","ENS"]).contains(a.type)}).uniq(function(a){return a.id}).value(),f.get_users(_(h).pluck("user_id"))):e.resolve({no_profile:!0})}).then(function(c){return _(c).has("data")?(h=_(h).indexBy("user_id"),a.push(_(c.data).map(function(a){a.type=d[h[a.id].type].name+" de l'\u00e9l\u00e8ve";return a})),c=_(b.groups).pluck("group_id"),f.get_groups(c)):e.resolve({no_profile:!0})},function(a){return e.reject(a)}).then(function(a){return _(a).has("data")?(g=_.chain(a.data).pluck("users").flatten().value(),
n=_(g).where({type:"ELV"}),0<n.length?f.get_users(_(n).pluck("user_id")):e.resolve({no_pupils:!0})):e.resolve({no_profile:!0})},function(a){return e.reject(a)}).then(function(b){n=_(n).indexBy("user_id");a.push(_(b.data).map(function(a){var c=1<b.data.length?"s":"";a.type="Autre"+c+" \u00e9l\u00e8ve"+c;return a}));l=_(g).where({type:"ENS"});return 0<l.length?f.get_users(_(l).pluck("user_id")):e.resolve()},function(a){return e.reject(a)}).then(function(b){l=_(l).indexBy("user_id");_(g).where({type:"PRI"});
a.push(_(b.data).map(function(a){a.type=d[l[a.id].type].name+" de l'\u00e9l\u00e8ve";f.get_subjects(_(a.groups).pluck("subject_id")).then(function(b){a.actual_subjects=b.data});return a}));return e.resolve()},function(a){return e.reject(a)}).then(function(){return e.resolve(_.chain(a).flatten().uniq(function(a){return a.id}).value())})});return b}}})}]);
angular.module("suiviApp").service("APIs",["$http","$q","Onglets","URL_ENT","APP_PATH",function(a,d,e,f,g){this.query_profiles_types=_.memoize(function(){return a.get(f+"/api/profiles_types")});this.get_users=_.memoize(function(b){return _(b).isEmpty()?d.resolve({data:[]}):a.get(f+"/api/users/",{params:{"id[]":b}})});this.get_group=_.memoize(function(b){return a.get(f+"/api/groups/"+b)});this.get_groups=_.memoize(function(b){return _(b).isEmpty()?d.resolve({data:[]}):a.get(f+"/api/groups/",{params:{"id[]":b}})});
this.get_groups_of_structures=_.memoize(function(b){return a.get(f+"/api/groups/",{params:{"structure_id[]":b}})});this.get_grades=_.memoize(function(b){return _(b).isEmpty()?d.resolve({data:[]}):a.get(f+"/api/grades/",{params:{"id[]":b}})});this.get_subjects=_.memoize(function(b){return _(b).isEmpty()?d.resolve({data:[]}):a.get(f+"/api/subjects/",{params:{"id[]":b}})});this.query_carnets_relevant_to=function(b){return a.get(g+"/api/carnets/relevant/"+b)};this.get_structure=_.memoize(function(b){return a.get(f+
"/api/structures/"+b)});this.get_structures=_.memoize(function(b){return a.get(f+"/api/structures/",{params:{"id[]":b}})});this.query_common_onglets_of=function(a){return e.query({"uids[]":a}).$promise.then(function(b){return d.resolve(_.chain(b).reject(function(a){return _(a).isEmpty()}).map(function(a){return _(a).toArray()}).flatten().groupBy("nom").toArray().select(function(b){return b.length==a.length}).flatten().groupBy("nom").value())},function(a){return d.resolve({})})}}]);
angular.module("suiviApp").service("Popups",["$uibModal","$q","Onglets","Droits","Saisies","APIs","UID","User",function(a,d,e,f,g,b,h,c){this.loading_window=function(a,b,c){return swal({title:a,text:b,type:"info",showLoaderOnConfirm:!0,onOpen:function(){return swal.clickConfirm()},preConfirm:function(){return new Promise(function(a){c().then(function(a){swal.closeModal()},function(a){console.log(a);swal.closeModal();swal({title:"Erreur :(",text:a.data.error,type:"error"})})})},allowOutsideClick:!1})};
this.onglet=function(b,g,p,n){a.open({template:'\n\x3cdiv class\x3d"modal-header"\x3e\n\x3ch3 class\x3d"modal-title"\x3e\nPropri\u00e9t\u00e9s de l\'onglet\n\x3c/h3\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"modal-body"\x3e\n\x3clabel\x3eTitre : \x3cinput type\x3d"text" maxlength\x3d"45" ng:model\x3d"$ctrl.onglet.nom" ng:maxlength\x3d"45" ng:change\x3d"$ctrl.onglet.dirty \x3d true; $ctrl.name_validation()" /\x3e\n\x3cspan class\x3d"label label-danger" ng:if\x3d"!$ctrl.valid_name"\x3eUn onglet existant porte d\u00e9j\u00e0 ce nom !\x3c/span\x3e\n\x3c/label\x3e\n\n\x3cspan class\x3d"label label-info" ng:if\x3d"$ctrl.uids"\x3eL\'\u00e9l\u00e8ve aura un acc\u00e8s en lecture/\u00e9criture \u00e0 cet onglet.\x3c/span\x3e\n\x3cdroits uid-eleve\x3d"$ctrl.uids"\ndroits\x3d"$ctrl.droits"\nconcerned-people\x3d"$ctrl.concerned_people"\nng:if\x3d"$ctrl.droits"\x3e\x3c/droits\x3e\n\n\x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\n\x3c/div\x3e\n\n\x3cdiv class\x3d"modal-footer"\x3e\n\x3cbutton class\x3d"btn btn-danger pull-left"\nng:click\x3d"$ctrl.delete()"\nng:if\x3d"$ctrl.onglet.id || $ctrl.onglet.ids"\x3e\n\x3cspan class\x3d"glyphicon glyphicon-trash"\x3e\x3c/span\x3e\n\x3cspan\x3e Supprimer l\'onglet\x3c/span\x3e\n\x3c/button\x3e\n\x3cbutton class\x3d"btn btn-default"\nng:click\x3d"$ctrl.cancel()"\x3e\n\x3cspan class\x3d"glyphicon glyphicon-remove-sign"\x3e\x3c/span\x3e\n\x3cspan ng:if\x3d"$ctrl.onglet.nom"\x3e Annuler\x3c/span\x3e\n\x3cspan ng:if\x3d"!$ctrl.onglet.nom"\x3e Fermer\x3c/span\x3e\n\x3c/button\x3e\n\x3cbutton class\x3d"btn btn-success"\nng:click\x3d"$ctrl.ok()"\nng:disabled\x3d"!$ctrl.onglet.nom || !$ctrl.valid_name"\x3e\n\x3cspan class\x3d"glyphicon glyphicon-ok-sign"\x3e\x3c/span\x3e Valider\n\x3c/button\x3e\n\x3c/div\x3e\n',
resolve:{uids:function(){return b},onglet:function(){return _(g).isNull()?{nom:""}:g},all_onglets:function(){return p}},controller:["$scope","$uibModalInstance","$q","Droits","APIs","URL_ENT","DEFAULT_RIGHTS_ONGLET","UID","uids","onglet","all_onglets",function(a,b,d,e,f,g,h,k,m,n,p){a.$ctrl=a;a.uids=m;a.onglet=n;a.all_onglets=p;a.onglet.delete=!1;a.valid_name=!0;_(a.onglet).has("id")?e.query({onglet_id:a.onglet.id}).$promise.then(function(b){a.droits=_(b).map(function(a){return new e(a)})},function(a){}):
(a.droits=[new e({uid:k,read:!0,write:!0,manage:!0})],a.droits.push(new e({uid:m,read:!0,write:!0,manage:!1})),a.droits=a.droits.concat(_(h).map(function(a){a=new e(a);a.dirty={profil_id:!0,read:!0,write:!0,manage:!0};return a})));1==m.length?c.get({id:m[0]}).$promise.then(function(b){a.eleve=b;a.eleve.query_people_concerned_about(m[0]).then(function(b){a.concerned_people=b},function(a){})},function(a){}):c.get({id:k}).$promise.then(function(b){a.concerned_people=[b];return f.get_users(m)},function(a){}).then(function(b){a.concerned_people=
...
showCancelButton:!0,confirmButtonColor:"#3085d6",confirmButtonText:"Oui, je confirme !",cancelButtonColor:"#d33",cancelButtonText:"Annuler"}).then(function(b){a.onglet.delete=!0;a.ok()})};a.cancel=function(){b.dismiss()}}]}).result.then(function(a){var c=null,k="rien";_(g).isNull()?(k="created",c=e.save({uids:b,nom:a.onglet.nom}).$promise):a.onglet.delete?(k="deleted",a.onglet["ids[]"]=a.onglet.ids,delete a.onglet.ids,c=e.delete(a.onglet).$promise):c=a.onglet.dirty?e.update(a.onglet).$promise:d.resolve(a.onglet);
c.then(function(c){void 0!=c.id&&(c=[c]);var d=c.map(function(a){return a.id});c.action=k;"deleted"!=k&&_.chain(a.droits).reject(function(a){return"created"==k&&_(a).has("uid")&&(a.uid==h||a.uid==b)}).each(function(a){a.to_delete?_(a).has("id")&&f.delete(a):a.dirty&&"..."!==a.uid&&"..."!==a.profil_id&&"..."!==a.sharable_id&&_(a.dirty).reduce(function(a,b){return a||b},!1)&&a.read&&(a.onglets_ids=d,_(a).has("id")?f.update(a):f.save(a))});n(c)},function(){})},function(){})}}]);
