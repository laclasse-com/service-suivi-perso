...
angular.module('suiviApp')
    .controller( 'CarnetsEvignalCtrl',
                 [ '$scope', '$rootScope', '$state', '$stateParams', 'Carnets', 'CarnetsEvignal', 'Rights', 'CurrentUser', 'Notifications',
                   function( $scope, $rootScope, $state, $stateParams, Carnets, CarnetsEvignal, Rights, CurrentUser, Notifications ) {
                       CarnetsEvignal.query().$promise
