...
.controller('RightsEvignalCtrl', ['$rootScope', '$scope', '$state', '$stateParams', 'CurrentUser', 'GetPersonnelsEtablissements', 'GetPersonnelsEvignal', 'Annuaire', 'Rights', '$modal', '$window', 'UAI_EVIGNAL',function($rootScope, $scope, $state, $stateParams, CurrentUser, GetPersonnelsEtablissements, GetPersonnelsEvignal, Annuaire, Rights, $modal, $window, UAI_EVIGNAL) {
