...
.controller('UploadTextAngularCtrl',['$rootScope', '$modalInstance', '$scope', '$upload', '$window', '$cookies', '$cookieStore', 'UPLOAD_SIZE', 'APP_PATH',
  function($rootScope, $modalInstance, $scope, $upload, $window, $cookies, $cookieStore, UPLOAD_SIZE, APP_PATH) {
    ...
    $scope.valider = function() {
    	if ($scope.upload_size) {
	    	$upload.upload({
		        ...
		        $rootScope.docs.push({nom: data.nom, md5: data.md5});
		        console.log(data);
