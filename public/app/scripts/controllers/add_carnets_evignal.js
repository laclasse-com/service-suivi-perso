...
.controller('AddCarnetsEvignalCtrl', ['$rootScope', '$scope', '$state', '$stateParams', 'Carnets', 'EvignalSearchByName', 'CurrentUser', '$modal', function($rootScope, $scope, $state, $stateParams, Carnets, EvignalSearchByName, CurrentUser, $modal) {
