...
.config(['$stateProvider', '$urlRouterProvider', 'APP_PATH', 'cfpLoadingBarProvider', function($stateProvider, $urlRouterProvider, APP_PATH, cfpLoadingBarProvider) {
  ...
  $stateProvider
          ...
          .state( 'suivi.classes',{
            resolve: { auth: function( Profil ) { Profil.redirection( ['ENS', 'DIR', 'ETA', 'EVS', 'CPE', 'DOC'] ); } },
            parent: 'suivi',
            url: '/classes',
            views: {
              'aside': {
          ...
          .state( 'suivi.carnets',{
           ...
           .state( 'suivi.carnet',
             { url: '/classes/:classe_id/carnets/:id',
              resolve: { auth: function( Profil ) { Profil.redirection( ['ENS', 'DIR', 'ETA', 'EVS', 'CPE', 'DOC', 'ELV', 'TUT'] ); } },
               views: {
                   'aside': {
