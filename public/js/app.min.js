var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,e,d){a instanceof String&&(a=String(a));for(var f=a.length,g=0;g<f;g++){var b=a[g];if(e.call(d,b,g,a))return{i:g,v:b}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,e,d){a!=Array.prototype&&a!=Object.prototype&&(a[e]=d.value)};
...
$jscomp.polyfill("Array.prototype.findIndex",function(a){return a?a:function(a,d){return $jscomp.findInternal(this,a,d).i}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.Symbol=function(){var a=0;return function(e){return $jscomp.SYMBOL_PREFIX+(e||"")+a++}}();
...
$jscomp.polyfill("Promise",function(a){function e(){this.batch_=null}function d(a){return a instanceof g?a:new g(function(c,b){c(a)})}if(a&&!$jscomp.FORCE_POLYFILL_PROMISE)return a;e.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};e.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var f=$jscomp.global.setTimeout;e.prototype.asyncExecuteFunction=function(a){f(a,
0)};e.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var c=0;c<a.length;++c){var b=a[c];a[c]=null;try{b()}catch(l){this.asyncThrow_(l)}}}this.batch_=null};e.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var g=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var c=this.createResolveAndReject_();try{a(c.resolve,c.reject)}catch(k){c.reject(k)}};g.prototype.createResolveAndReject_=
...
0;a<this.onSettledCallbacks_.length;++a)b.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var b=new e;g.prototype.settleSameAsPromise_=function(a){var c=this.createResolveAndReject_();a.callWhenSettled_(c.resolve,c.reject)};g.prototype.settleSameAsThenable_=function(a,c){var b=this.createResolveAndReject_();try{a.call(c,b.resolve,b.reject)}catch(l){b.reject(l)}};g.prototype.then=function(a,c){function b(a,c){return"function"==typeof a?function(c){try{e(a(c))}catch(q){d(q)}}:
c}var e,d,f=new g(function(a,c){e=a;d=c});this.callWhenSettled_(b(a,e),b(c,d));return f};g.prototype.catch=function(a){return this.then(void 0,a)};g.prototype.callWhenSettled_=function(a,c){function k(){switch(e.state_){case 1:a(e.result_);break;case 2:c(e.result_);break;default:throw Error("Unexpected state: "+e.state_);}}var e=this;null==this.onSettledCallbacks_?b.asyncExecute(k):this.onSettledCallbacks_.push(k)};g.resolve=d;g.reject=function(a){return new g(function(c,b){b(a)})};g.race=function(a){return new g(function(c,
b){for(var e=$jscomp.makeIterator(a),k=e.next();!k.done;k=e.next())d(k.value).callWhenSettled_(c,b)})};g.all=function(a){var c=$jscomp.makeIterator(a),b=c.next();return b.done?d([]):new g(function(a,e){function k(c){return function(b){f[c]=b;l--;0==l&&a(f)}}var f=[],l=0;do f.push(void 0),l++,d(b.value).callWhenSettled_(k(f.length-1),e),b=c.next();while(!b.done)})};return g},"es6","es3");
...
!0;a.manage&&!a.write&&(a.write=!0,a.dirty.write=!0);a.manage&&!a.read&&(a.read=!0,a.dirty.read=!0)};b.update_deletabilities=function(){b.droits.forEach(function(a){a.deletable=a.uid!=d;void 0!=b.uidEleve&&(a.deletable=a.deletable&&a.uid!=b.uidEleve)})};b.$onInit=function(){b.UID=d;b.update_deletabilities();e.query_profiles_types().then(function(a){b.profils=a.data},function(a){});g.get({id:d}).$promise.then(function(a){return a.get_actual_groups()}).then(function(a){b.groups=a.filter(function(a){return"GPL"==
...
angular.module("suiviApp").config(["$compileProvider",function(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|javascript|blob|data):/)}]).component("onglet",{bindings:{uids:"\x3c",onglets:"\x3c",onglet:"\x3d"},controller:["$uibModal","$state","$q","$window","$sce","$location","Saisies",function(a,e,d,f,g,b,h){var c=this;c.order_by={field:"date",reverse:!0};c.callback_popup_onglet=function(a){"deleted"==a.action&&e.go("carnet",{uids:c.uids},{reload:!0})};c.saisie_callback=function(a){switch(a.action){case "created":c.saisies.push(a);
...
angular.module("suiviApp").component("onglets",{bindings:{uids:"\x3c"},controller:["$uibModal","Onglets","Popups","APIs","User","UID",function(a,e,d,f,g,b){var h=this;h.popup_onglet=d.onglet;h.callback_popup_onglet=function(a){if(a[0].created){var c=a[0];c.ids=a.map(function(a){return a.id});h.onglets.push(c)}a[0].deleted&&(h.onglets=h.onglets.filter(function(c){return c.nom!=a[0].nom}))};h.$onInit=function(){1==h.uids.length?d.loading_window("Chargement des onglets","",function(){return e.query({"uids[]":h.uids}).$promise.then(function(a){h.onglets=
_(a[0]).map(function(a){a.ids=[a.id];return a})},function(a){})}):d.loading_window("Chargement des onglets communs","",function(){return f.query_common_onglets_of(h.uids).then(function(a){h.onglets=Object.keys(a).map(function(c){return{nom:c,ids:a[c].map(function(a){return a.id}),writable:a[c].reduce(function(a,c){return a&&c.writable},!0),manageable:a[c].reduce(function(a,c){return a&&c.manageable},!0)}})})});g.get({id:b}).$promise.then(function(a){h.current_user=a;h.can_add_tab=h.current_user.can_add_tab(h.uids)})}}],
...
var k=function(a){return(_(a.match(/^(user|http)/)).isNull()?d+"/":"")+a};c.apply_filters=function(){var a=_.chain(c.structures).where({selected:!0}).pluck("id").value(),b=_.chain(c.groups).where({selected:!0}).pluck("id").value(),d=_.chain(c.grades).where({selected:!0}).pluck("id").value(),e=function(a){return _.chain(c.groups).select(function(c){return _(a).contains(c.id)}).pluck("grades").flatten().pluck("grade_id").uniq().value()},f=function(a){return _.chain(c.groups).select(function(c){return _(a).contains(c.id)}).pluck("structure_id").uniq().value()};
return function(g){return(""+g.firstname+g.lastname).toLocaleLowerCase().includes(c.filters.text.toLocaleLowerCase())&&(0==a.length||0<_(a).intersection(f(_(g.groups).pluck("group_id"))).length)&&(0==b.length||0<_(b).intersection(_(g.groups).pluck("group_id")).length)&&(0==d.length||0<_(d).intersection(e(_(g.groups).pluck("group_id"))).length)&&(!c.only_display_relevant_to||g.relevant)}};c.clear_filters=function(a){_(["CLS","GRP","GPL"]).contains(a)?_.chain(c.groups).select(function(c){return c.selected&&
...
a.type}).pluck("user_id").value())},h=function(a){1<a.length&&f.get_structures(a).then(function(a){c.structures=c.structures.concat(a.data);c.structures=_(c.structures).uniq(function(a){return a.id})})};_.chain(c.current_user.profiles).pluck("type").contains("ELV").value()&&b.push(c.current_user.id);b=b.concat(_(c.current_user.children).pluck("child_id"));a=_.chain(a).reject(function(a){return _(["ELV"]).contains(a.type)}).pluck("id").value();0<a.length&&d.push(f.get_groups(a).then(function(a){h(_.chain(a.data).pluck("structure_id").uniq().value());
g(a.data)}));a=_.chain(c.current_user.profiles).select(function(a){return _("ADM DIR DOC ETA EVS ORI".split(" ")).contains(a.type)}).pluck("structure_id").uniq().value();_(a).isEmpty()||(h(a),d.push(f.get_groups_of_structures(a).then(function(a){g(a.data)})));e.all(d).then(function(){for(b=_(b).uniq();0<b.length;)f.get_users(b.splice(0,200)).then(function(a){c.eleves=c.eleves.concat(_(a.data).map(function(a){a.avatar=k(a.avatar);a.excluded=!1;a.relevant=_(c.relevant_to).contains(a.id);var b=_.chain(a.groups).map(function(a){return _(c.groups).findWhere({id:a.group_id,
...
"/api/structures/"+b)});this.get_structures=_.memoize(function(b){return a.get(f+"/api/structures/",{params:{"id[]":b}})});this.query_common_onglets_of=function(a){return d.query({"uids[]":a}).$promise.then(function(b){return e.resolve(_.chain(b).reject(function(a){return _(a).isEmpty()}).map(function(a){return _(a).toArray()}).flatten().groupBy("nom").toArray().select(function(b){return b.length==a.length}).flatten().groupBy("nom").value())},function(a){return e.resolve({})})}}]);
