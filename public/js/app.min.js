...
angular.module("suiviApp").component("onglets",{bindings:{uids:"\x3c"},controller:["$uibModal","Onglets","Popups","APIs","User","UID",function(a,e,d,f,g,b){var h=this;h.popup_onglet=d.onglet;h.callback_popup_onglet=function(a){console.log("callback_popup_onglet");console.log(a);"created"==a.action&&(a=_(a).groupBy("name"),h.onglets=h.onglets.concat(Object.keys(a).map(function(b){return{name:b,ids:a[b].map(function(a){return a.id}),writable:a[b].reduce(function(a,b){return a&&b.writable},!0),manageable:a[b].reduce(function(a,
b){return a&&b.manageable},!0)}})));a.deleted&&(h.onglets=h.onglets.filter(function(b){return b.name!=a.name}));Array.isArray(a)&&a[0].deleted&&(h.onglets=h.onglets.filter(function(b){return b.name!=a[0].name}))};h.$onInit=function(){1==h.uids.length?d.loading_window("Chargement des onglets","",function(){return e.query({"uids[]":h.uids}).$promise.then(function(a){h.onglets=_(a[0]).map(function(a){a.ids=[a.id];return a})},function(a){})}):d.loading_window("Chargement des onglets communs","",function(){return f.query_common_onglets_of(h.uids).then(function(a){h.onglets=
...
null,k="rien";null==g?(k="created",c=d.save({uids:b,names:void 0==a.onglet.names?[a.onglet.name]:a.onglet.names}).$promise):a.onglet.deleted?(k="deleted",a.onglet["ids[]"]=a.onglet.ids,delete a.onglet.ids,delete a.onglet.id,c=d.delete(a.onglet).$promise):c=a.onglet.dirty?d.update(a.onglet).$promise:e.resolve([a.onglet]);c.then(function(c){console.log(c);c.action=k;"deleted"!=k&&_.chain(a.droits).reject(function(a){return"created"==k&&_(a).has("uid")&&(a.uid==h||a.uid==b)}).each(function(a){a.to_delete&&
(_(a).has("id")||_(a).has("ids"))?f.delete(a):!a.to_delete&&a.dirty&&"..."!=a.uid&&"..."!=a.profile_type&&"..."!=a.sharable_id&&_(a.dirty).reduce(function(a,b){return a||b},!1)&&(a.onglets_ids=c.map(function(a){return a.id}),(_(a).has("id")||_(a).has("ids")?f.update(a):f.save(a)).$promise.then(function(a){return!0},function(a){return!1}))});m(c)},function(){})},function(){})}}]);
