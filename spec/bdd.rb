module BDD
  ...
  def BDD::clear_db
    ...
    DroitsSpecifiques.all.each do |right|
      right.delete
    end

    EntreesOnglets.all.each do |entreeOnglet|
      entreeOnglet.delete
    end

    Saisies.all.each do |entree|
      entree.delete
    end

    CarnetsOnglets.all.each do |carnetOnglet|
      carnetOnglet.delete
    end

    Onglets.all.each do |onglet|
      onglet.delete
    end
